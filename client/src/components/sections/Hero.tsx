      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          ...
          <div className="flex-1 space-y-5 text-center md:text-left mt-[20px] mb-[20px]">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start animate-fade-in-up mt-[0px] mb-[0px] pt-[10px] pb-[10px]" style={{ animationDelay: '0.2s' }}>
