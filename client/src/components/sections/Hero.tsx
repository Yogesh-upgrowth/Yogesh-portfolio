  ...
  return (
    <section className="relative overflow-hidden bg-background md:pt-28 md:pb-16 pt-[50px] pb-[50px]">
      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 pt-[20px] pb-[20px] mt-[20px] mb-[20px]">
          ...
          <div className="flex-1 space-y-5 text-center md:text-left">
            ...
            <motion.div
              ...
              className="pt-2 flex items-center justify-center md:justify-start gap-6 text-sm text-muted-foreground"
            >
