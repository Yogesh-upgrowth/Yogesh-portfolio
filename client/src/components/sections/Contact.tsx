        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4">
              <a href="mailto:yogesh.productmanager@gmail.com" className="flex items-center gap-4 p-4 rounded-lg bg-background border hover:border-primary/50 transition-colors group">
              ...
              <div className="flex items-center gap-4 p-4 rounded-lg bg-background border hover:border-primary/50 transition-colors group cursor-pointer">
            ...
            <CardContent className="p-8">
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  />
                  <Button type="submit" size="lg" className="w-full text-lg font-semibold h-12">
                    Send Message
                  </Button>
                </form>
              </Form>
