    ...
    <section className="bg-muted/30 border-y border-border/40 py-12">
      <div className="container px-4 mx-auto">
        ...
        <div className="mt-12 pt-8 border-t border-border/40">
          ...
          >
            <span className="px-5 py-2 bg-primary/10 text-primary font-semibold rounded-full text-sm border border-primary/20 hover-lift">Fintech</span>
            <span className="px-5 py-2 bg-primary/10 text-primary font-semibold rounded-full text-sm border border-primary/20 hover-lift">Mobility</span>
            <span className="px-5 py-2 bg-primary/10 text-primary font-semibold rounded-full text-sm border border-primary/20 hover-lift">SaaS</span>
            <span className="px-5 py-2 bg-primary/10 text-primary font-semibold rounded-full text-sm border border-primary/20 hover-lift">Marketplaces</span>
            <span className="px-5 py-2 bg-primary/10 text-primary font-semibold rounded-full text-sm border border-primary/20 hover-lift">E-commerce</span>
          </div>
        </div>
      </div>
    </section>
