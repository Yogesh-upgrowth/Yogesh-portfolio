  ...
  return (
    <div className="space-y-2">
      ...
      <section id="hook" className="scroll-mt-28">
        ...
        <p className="text-base md:text-lg text-foreground/80 leading-[1.85] mb-6">V2 took a different approach. The story of building V2 — and what it took to actually make recommendations that helped — is more interesting than the original launch.</p>
      </section>
